!function(_) {
  "use strict";
  var $, e, t, l, s, a, n, c, p, o, i, r, h, d, v, g, u, m = !1;
  function w(_, $) {
      var e = new Date;
  ...
  -1 != location.href.indexOf("envato-elements") ? (null == b("isEnvatoEl") && w("isEnvatoEl", "yes"),
  m = !0) : m = !1,
  !b("hideBslPopup") && ($ = _(".bsl-popup__buttons"),
      ...
      setTimeout(function() {
          _.ajax({
              ...
              success: function(e) {
                  ...
                  _.each(e.items, function(e, t) {
                      ...
                      _.each(t, function(_, e) {
                          _ == p && function _($, e, t, l, s) {
                              ...
                              "yes" != b("isEnvatoEl") && $.append('<a href="' + e.links.buy + '" target="_blank" class="b-po buy" rel="noopener"><svg id="svg-icon-cart" enable-background="new 0 0 511.343 511.343" height="512" viewBox="0 0 511.343 511.343" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m490.334 106.668h-399.808l-5.943-66.207c-.972-10.827-10.046-19.123-20.916-19.123h-42.667c-11.598 0-21 9.402-21 21s9.402 21 21 21h23.468c12.825 142.882-20.321-226.415 24.153 269.089 1.714 19.394 12.193 40.439 30.245 54.739-32.547 41.564-2.809 102.839 50.134 102.839 43.942 0 74.935-43.826 59.866-85.334h114.936c-15.05 41.455 15.876 85.334 59.866 85.334 35.106 0 63.667-28.561 63.667-63.667s-28.561-63.667-63.667-63.667h-234.526c-15.952 0-29.853-9.624-35.853-23.646l335.608-19.724c9.162-.538 16.914-6.966 19.141-15.87l42.67-170.67c3.308-13.234-6.71-26.093-20.374-26.093zm-341.334 341.337c-11.946 0-21.666-9.72-21.666-21.667s9.72-21.667 21.666-21.667c11.947 0 21.667 9.72 21.667 21.667s-9.72 21.667-21.667 21.667zm234.667 0c-11.947 0-21.667-9.72-21.667-21.667s9.72-21.667 21.667-21.667 21.667 9.72 21.667 21.667-9.72 21.667-21.667 21.667zm47.366-169.726-323.397 19.005-13.34-148.617h369.142z"/></svg><span>Buy Theme</span></a>'),
                              m && "html" != l && "jekyll" != l && "hugo" != l && "react" != l || $.append('<a href="#related" id="relatedThemes" class="b-po rel" rel="noopener"><svg id="svg-icon-rel" width="24px" height="24px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg><span>Demo / Related</span></a>'),
                              "aster" == s && (s = "oblo"),
                              void 0 !== t.wordpress[s] && ("html" == l || "jekyll" == l || "hugo" == l || "react" == l) && $.append('<a href="' + t.wordpress[s].links.buy + '" target="_blank" id="wordpressTheme" class="b-po wor" rel="noopener"><svg id="svg-icon-wor" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 512 512"><rect width="512" height="512" rx="15%" fill="#05a8da"/><circle cx="256" cy="256" fill="none" r="182" stroke="#fff" stroke-width="20"/><path d="m315 424 28-15 54-156c10-25 13-45 13-62 0-32-13-60-36-63-21-2-33 19-32 31 2 29 31 45 31 85 0 28-18 73-31 117l-62-187 20-1c10 0 9-15-1-14-31 3-60 2-92 0-10-1-10 14-1 14l18 1 27 74-38 114-63-188 20-1c9 0 8-15-1-14-29 2-57 4-64-1l-8 24 84 233 25 14 54-158" fill="#fff"/></svg><span>WP Theme</span></a>');
                  ...
                  a = o,
                  n = "",
                  s.demo ? n += '<a href="#tab-demo" class="active">Demo</a><a href="#tab-related">Related</a>' : n += '<a href="#tab-related" class="active">Related</a>',
                  n += '<a href="#tab-all">All</a>',
                  ("html" == a || "jekyll" == a || "hugo" == a || "react" == a) && (n += '<a href="#tab-version">Version</a>'),
                  t.html(n)
              },
              error: function(_, $, e) {
                  console.log("Error:", e)
  ...
  _(document).on("click", "#relatedThemes", function() {
      return _(this).hasClass("active") ? (t.parent().removeClass("opened"),
      _(this).removeClass("active")) : (_(this).parent().find("a:not(#relatedThemes)").removeClass("active"),
      _(this).addClass("active"),
      t.parent().find(".bsl-popup__content").removeClass("active"),
      t.addClass("active"),
      t.parent().hasClass("opened") || t.parent().addClass("opened"),
      i.demo ? _('.bsl-popup__menu a[href="#tab-demo"]').trigger("click") : _('.bsl-popup__menu a[href="#tab-related"]').trigger("click")),
      0 == _(".bsl-popup__tab-related ul li").length && 0 == _('.bsl-popup__menu a[href="#tab-demo"]').length && _('.bsl-popup__menu a[href="#tab-all"]').trigger("click"),
      !1
  }),
  _(document).on("click", "#helpThemes", function() {
      var $, t, l;
      return _(this).hasClass("active") ? (e.parent().removeClass("opened"),
      _(this).removeClass("active")) : (_(this).parent().find("a:not(#helpThemes)").removeClass("active"),
      _(this).addClass("active"),
  ...
  _(document).on("click", ".bsl-popup__menu a", function() {
      ...
      _(this).addClass("active");
      var $, e, t, l, o, m, w, b, f, x, C, k, z, y, M, B, T = _(this).attr("href").replace("#tab-", "");
      return _(".bsl-popup__tab").removeClass("active"),
      ...
      _.each(e.demo, function(_, $) {
          l += '<li><a href="' + $.url + '"><img src="' + $.preview + '" alt="' + $.title + '" /><span>' + $.title + "</span></a></li>"
      }),
      l += "</ul>",
      $.html(l)),
      "related" != T || v || (v = !0,
      ...
      C = "<ul>",
      _.each(m, function($, e) {
          $ != b && _.each(x, function(_, t) {
              e.tags.includes(t) && -1 === f.findIndex(_=>_.slug == $) && f.push({
                  slug: $,
                  item: e
              })
          })
      ...
      _.each(f, function(_, $) {
          C += '<li><a href="' + $.item.links.url + '" target="_blank"><img src="' + $.item.preview + '" alt="' + $.item.title + '" /><span>' + $.item.title + "</span></a></li>"
      }),
      C += "</ul>",
      o.html(C)),
      "all" != T || g || (g = !0,
      function $(e, t, l, s) {
          ...
          _.each(a, function(_, $) {
              n += '<li><a href="' + $.item.links.url + '" target="_blank"><img src="' + $.item.preview + '" alt="' + $.item.title + '" /><span>' + $.item.title + "</span></a></li>"
          }),
          n += "</ul>",
          e.html(n)
      }(a, r, i, p)),
      ...
      B = "<ul>",
      _.each(M, function(_, $) {
          B += '<li><a href="' + $.item.links.url + '" target="_blank"><img src="' + $.item.preview + '" alt="' + $.item.title + '" /><span>' + $.item.title + " [" + $.slug + "]</span></a></li>"
      }),
      B += "</ul>",
      k.html(B)),
      !1
